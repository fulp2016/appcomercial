...
function mesantes() {
         ...
         setTimeout('escribirdias()',1000); //llamada a funcion de cambio de tabla.
...
function mesdespues() {
         ...
         setTimeout('escribirdias()',1000); //escribir la tabla
         }
...
function mifecha() {
         ...
         if (isNaN(mianno) || mianno<1) { 
            ...
            alert("El año no es válido:\n debe ser un número mayor que 0")
              ...
              setTimeout('escribirdias()',1000); //escribir tabla
              }
         }